export const URL = {
  ...
  allImg: '/uwb/file/fdfs/files',  // 图片列表
  changeImg: '/uwb/file/fdfs/update', // 修改图片信息
  fdfsSwitch: '/uwb/file/fdfs/switch', // 地图启用开关
  personnelList: '/uwb/resources/person/persons', // 人员信息列表
  delMap: '/uwb/file/fdfs/delete', // 删除地图文件
  upImg: '/uwb/file/fdfs/upload', // 图片上传
  ...
  version: '/uwb/access/upgrade/version', // 版本查询
  upgrade: '/uwb/access/upgrade/update', // 版本升级
