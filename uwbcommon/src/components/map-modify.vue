<template>
  <div class="map-modify">
    <div class="box">
      <div class="head">
        <div class="title">修改地图信息</div>
        <div @click="close" class="close">x</div>
      </div>
      <div class="main">
        <div class="row">
          <div class="row">
            <span class="describe-one">地图名称</span>
        ...
        <div class="row">
          <span class="describe-two">长</span>
          <input v-model="info.length" type="text" class="min-box">
          <span class="describe-two">宽</span>  
          <input v-model="info.width" type="text" class="min-box">
        </div>
      </div>
      <div class="but">
...
export default {
  ...
  methods: {
    ...
    upData() {
      this.$http
        .Post(this.$url.changeImg, {id: this.info.id, length: this.info.length, width: this.info.width, name: this.info.name})
        .then(res => {})
        .catch(rej => {
