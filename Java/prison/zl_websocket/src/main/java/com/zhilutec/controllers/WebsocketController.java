...
public class WebsocketController {
    ...
    public String getAmount(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            return websocketService.getWaningAmount();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String resetAmount(HttpServletRequest request, HttpServletResponse response,
        ...
        logger.info("=====RequestBody:" + requestBody);
        try {
            return websocketService.resetWarning(requestBody);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String areaInfo(HttpServletRequest request, HttpServletResponse response,
        ...
        logger.info("=====RequestBody:" + requestBody);
        try {
            return websocketService.getStatisticsInfo(requestBody);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String prisoner(HttpServletRequest request, HttpServletResponse response,
        ...
        logger.info("=====RequestBody:" + requestBody);
        try {
            return websocketService.getPrisonerMsg(requestBody);
        } catch (Exception e) {
            e.printStackTrace();
