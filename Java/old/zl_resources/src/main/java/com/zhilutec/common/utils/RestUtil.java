...
public class RestUtil {
    ...
    @Value("${websocket.server.ipaddr}")
    private String wsIpaddr;
    private  static final  String Ipaddr = "http://192.168.10.9:8802";

    /**
     * 获取未查看报警数量的url
     */
    private static final String GetAmountUrl = Ipaddr + "/websocket/tcp/get";
    /**
     * 获取重置未查看报警数量的url
     */
    private static final String ResetAmountUrl = Ipaddr + "/websocket/tcp/reset";

    /**
     * 获取重置未查看报警数量的url
     */
    private static final String AreaInfoUrl = Ipaddr + "/websocket/tcp/areaInfo";

    /**
     * 获取重置未查看报警数量的url
     */
    private static final String PrisonerUrl = Ipaddr + "/websocket/tcp/prisoner";
