...
@Service
@Transactional
public class TagStatusRedisServiceImpl extends IRedisService<TagStatusEntity> implements ITagStatusRedisService {
	
	@Autowired
	private TagStatusDao tagStatusDao;

	private static final String STATUS_REDIS_KEY = "STATUS_INFO";

	@Override
	protected String getRedisKey() {
		return STATUS_REDIS_KEY;
	}
