...
import com.zhilutec.uwb.common.util.JWTUtil;
import com.zhilutec.uwb.common.util.MD5Util;

import com.zhilutec.uwb.entity.User;
import com.zhilutec.uwb.service.ILoginService;
    ...
    public String login(HttpServletRequest request, JSONObject requestJson) {
        ...
        if (iscorrect) {
            try {
                ...
                //md5Token作为key
                String key = ConstantUtil.ACCOUNT_PRE + md5Token;

                //accountkey
                String accountkey = ConstantUtil.ACCOUNT_PRE + username;
