...
//    }
    ...
    public final static boolean isNull(Double d) {
    ...
    public final static boolean isNotNull(Double d) {
        return !isNull(d);
    }
    ...
    public final static boolean stringCheckDot(String str) {
        return match(str, "^[a-zA-Z0-9\u4e00-\u9fa5-_.]+$");
    }
    ...
    public final static boolean isHex(String str) {
        return match(str, "^[0-9a-fA-F]*$");
    }
     ...
     * @author jiqinlin
     */
    public final static boolean isPositiveFloat(String str) {
    ...
    public static boolean isUri(String val) {
        ...
        String regex2 = "/";
        if (val.matches(regex) || val.matches(regex2)) {
            return true;
        } else {
            return false;
        }
