...
# :set ff?
# :set ff=unix
# nohup java -jar -Xms64m -Xmx256m /home/project/prison/zl_resources-1.0.0-uwb-SNAPSHOT.jar >/dev/null 2>&1 & 
# specify the config
#nohup java -jar -Xms64m -Xmx256m zl_producer-1.0.0-prison-SNAPSHOT.jar -Dspring.config.location=/home/project/prison/config/producer/application.propertie > /dev/null 2>&1 &
#java -jar -Xms64m -Xmx256mzl_fastdfs-1.0.0-prison-SNAPSHOT.jar --fastdfs.tracker_servers=192.168.10.196:22122
...
SERVICE_HOME=""
NAME=prison.sh
SCRIPTNAME=/home/project/prison/shell/${NAME}
CONF_HOME=/home/project/prison/config
COMMON_SLEEP=5s
SRV_SLEEP=10s
...
CONSUMER="consumer"
WEBSOCKET="websocket"
SERVICES=($RESOURCES $PERMISSION $PRODUCER $CONSUMER $WEBSOCKET)
